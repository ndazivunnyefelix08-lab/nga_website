        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navMenuMain">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="index.php#spes">Programs</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu shadow" aria-labelledby="navbarPages">
                            <li><a class="dropdown-item" href="nga_events.php">News & Events</a></li>
                            <li><a class="dropdown-item" href="index.php#student-histories">Stories</a></li>
                            <li><a class="dropdown-item" href="index.php#partners">Partners</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="https://nga.ac.rw/mis/login" >MIS Portal</a></li>
                        </ul>
                    </li>
                ...
                <a href="./coding-academy/" class="btn-sk-admission">
                    Coding Academy
                </a>
            </div>
        </div>
